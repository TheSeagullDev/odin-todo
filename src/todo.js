export default function createTodo(title, description, priority, dueDate, checked = false) {
    ...
    return {getTitle, getDescription, getDueDate, getPriority, getAttributes, setTitle, setDescription, setDueDate, setPriority, setAttributes, getChecked, toggleChecked};
}